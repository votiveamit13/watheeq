...
export default function CreateServiceRequest() {
  ...
  <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-[] to-[#13498B]" style={{borderRadius:'10px'}}></div>
      ...
      <div className="mt-5">
        <h3 className="text-2xl font-bold">تفاصيل حجز الموعد :</h3>
        <p className="mt-5 leading-[2] text-[#000000B2]">
          هل لديك استفسار قانوني أو تحتاج استشارة مباشرة؟  من خلال هذه الخدمة
          يمكنك حجز موعد مع المحامي لمناقشة قضاياك القانونية وجهًا لوجه أو عبر
          مكالمة آمنة.  اختر الوقت المناسب، واستعد لنقاش احترافي يضعك على الطريق
          الصحيح.
        </p>
      </div>
      <div className="mt-10">

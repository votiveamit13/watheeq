  ...
  return (
    <section className="font-omnes justify-between px-4 md:px-8 lg:px-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 md:gap-x-16 lg:gap-x-24 gap-y-10">
        ...
        <Reason content={t("why-watheeq-reason-2")} icon="./assets/img/whychooseus5.png" />
        <Reason content={t("why-watheeq-reason-3")} icon="./assets/img/whychooseus4.png" />
        <Reason content={t("why-watheeq-reason-4")} icon="./assets/img/whychooseus3.png" />
        <Reason content={t("why-watheeq-reason-5")} icon="./assets/img/whychooseus2.png" />
        <Reason content={t("why-watheeq-reason-6")} icon="./assets/img/whychooseus1.png" />
      </div>

        ...
        <table className="w-[95%] text-right ">
          <thead>
            <tr className="text-[#96A5B8] font-medium">
              ...
              <th className="py-2 px-8">البريد</th>
          ...
          <tbody>
            {managers.map((manager, index) => (
              ...
              >
                ...
                <td
                  className="py-2 px-8 text-[#0B2B5166]"
                  style={{ textDecoration: "underline", color: "#0B2B51" }}
                >
                  {manager.mail}
                </td>
                <td
            ...
            <div className="bg-white w-[600px] rounded-xl p-5 relative">
              ...
              <form className="space-y-3 mt-5 mb-5">
                ...
                <div className="w-full flex justify-center">
                  <button
                    className="cursor-pointer mt-5 w-[120px] bg-[#13498B] text-white font-bold rounded-lg py-3 px-8"
                    onClick={() => setShowDialog(false)}
                  >
                    إضافة
                  </button>
